...
from filters.particle import gaussian_particles,predict_2,update,neff,estimate,resample_from_index
from wrapper import stanley, pid_control, State, Control
# -------------- Filter.py ----------------
...
def main():
    ...
    state = State(x_path[0],y_path[0],np.radians(90.0),v=0.0)
    
    #pd = PID(Kp=0.5,Ki=0.1,Kd=-0.15)
    control_struct = Control(0.5,0.1,-0.15,0,0,0,0,0)
